...
if (isset($_POST ['confirm'])) {
  ...
  if ($_POST ['token'] == hash ( "sha256", session_id () )) {
      ...
      //プリペアドステートメント作成
      $stmt = $dbdb->prepare("
      INSERT INTO response(NAME,TITLE,TEXT,CREATE_DATE,ARTICLE_ID)
       VALUES(:name,:title,:text,now(),:id)"
       );
      ...
      $stmt->bindParam(':id',$_SESSION['responseid'],PDO::PARAM_STR);

//クエリの実行
      $stmt->execute();
      $id1 = $_SESSION['responseid'];
      var_dump(strval($id1));
      $id2 = "thread.php?id=";
      $id2 .= $id1;
      header("Location:$id2");
    ...
    <div id="form">
      <form method="post">
        <table class="type03">
         ...
         <tr>
           <th>記事ナンバー</th>
           <td><?php echo $_SESSION['responseid'];?></td>
         </tr>
