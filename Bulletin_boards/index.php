...
$db = new DB();
$dbdb =$db -> dbConnect();
$stmt = $dbdb -> prepare("select ARTICLE_ID,CREATE_DATE,NAME,TITLE,TEXT from article order by CREATE_DATE DESC LIMIT :page, :num");
$page = $page * $num;
...
<head>
  ...
  <title>掲示板</title><?php echo $_SESSION['USERID'];?>
       ...
       while($row = $stmt -> fetch()){
        ...
        <tr>
          ...
          <th><a href="thread.php?id=<?php echo htmlspecialchars($row['ARTICLE_ID'],ENT_QUOTES,'UTF-8'),false;?>">
            ...
            <th><a href="edit.php">編集</a></th>
            <th><a href="delete.php">削除</a></th>
          </tr>
          <?php
        }
        ?>
